...
<div class="row inbox-wrapper">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <h4 class="mb-3">Listado de Hoteles</h4>
                    <div class="mb-5">
                        @can('hotel.create')
                        <button type="button"  data-bs-toggle="tooltip" data-bs-title="Agregar" class="btn btn-primary mb-2 mb-md-0 " onclick="agregar()">
                            <i data-feather="plus-circle"></i><b> &nbsp; Crear Hotel</b>
                        </button>
                        @endcan
                    </div>
                        ...
                        <table id="hotels" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('hotel.edit')
                                        <button type="button"  data-bs-toggle="tooltip" data-bs-title="Editar" class="btn btn-primary btn-icon edit" onclick="editar('{{$hotel->id}}','{{$hotel->nombre}}','{{$hotel->celular}}','{{$hotel->direccion}}','{{$hotel->precio}}')">
                                            <i data-feather="edit"></i>
                                        </button>
                                        @endcan
                                        @can('hotel.destroy')
                                        <button type="button" class="btn btn-danger btn-icon" data-bs-toggle="modal" data-bs-target="#Eliminar" data-id="{{$hotel->id}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('hotel.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @include('pages.hotel.form')
