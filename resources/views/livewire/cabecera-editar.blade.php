<div>
    ...
    <div class="row inbox-wrapper">
        ...
        <div class="col-md-12 mb-3" id="video">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-12" >
                                        ...
                                        <table id="vias" class="table">
                                            ...
                                            @if($imagenes)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex gap-2">
                                                        {{-- <input type="file" class="form-control h-100" name="imagenes.{{$i}}" id="imagenes.{{$i}}" wire:model.defer="imagenes.{{$i}}"> --}}
                                                        @if($imagenes[$i]!= null)
                                            ...
                                            @for($j;$j<$cont5;$j++)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="file"  class="form-control" name="imagenes2.{{$j}}" id="imagenes2.{{$j}}" wire:model.defer="imagenes2.{{$j}}">
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-icon" wire:click="reducirGaleria2({{$j}})" tabindex="119">-</button>
                                                    </td>
                                                </tr>
                                            @endfor
                                            </tbody>
