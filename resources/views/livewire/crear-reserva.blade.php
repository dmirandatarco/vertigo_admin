                ...
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4" wire:ignore>
                                    <div role="group"  class="btn-group btn-group-lg  form-switch mb-2">
                                        <label class="form-check-label me-5" for="tipoReserva">Reserva Combo</label>
                                        <input type="checkbox" class="form-check-input me-3" id="tipoReserva" wire:model="tipoReserva" />
                                        <label class="form-check-label" for="tipoReserva">Reserva Detallada</label>
                                    </div>
                                </div>
                                {{-- <div class="mb-3 col-md-4" wire:ignore>
                                    <div role="group"  class="btn-group btn-group-lg  form-switch mb-2">
                                        <label class="form-check-label me-5" for="formaReserva">Grupal</label>
                                        <input type="checkbox" class="form-check-input me-3" id="formaReserva" wire:model="formaReserva" />
                                        <label class="form-check-label" for="formaReserva">Privado</label>
                                    </div>
                                </div> --}}
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @for($i=0;$i<$cont;$i++)
                                            <tr >
                                                <td><input type="number" class="form-control" placeholder="Nº" name="cantidad[]" id="cantidad.{{$i}}" wire:model="cantidad.{{$i}}">
                                                    @error('cantidad.'.$i)
                                                ...
                                                <td>
                                                    <select class="form-select" name="moneda_id[]" id="moneda_id.{{$i}}" wire:model="moneda_id.{{$i}}">
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" name="precio[]" id="precio.{{$i}}" wire:model="precio.{{$i}}" step="0.01" placeholder="Precio">
                                                    @error('precio.'.$i)
                                                        <span class="error-message" style="color:red">Campo Obligatorio</span>
                                                    @enderror
                                                </td>
                    ...
                    <div class="row flex justify-content-end">
                        ...
                        <div class="mb-3 col-md-2">
                            ...
                            <input type="number" class="form-control" name="totaldolares" id="totaldolares" wire:model="totaldolares" disabled>
                            @error('totaldolares')
                                <span class="error-message" style="color:red">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 col-md-2">
                            ...
                            <input type="number" class="form-control" name="totalsoles" id="totalsoles" wire:model="totalsoles" disabled>
                            @error('totalsoles')
                                <span class="error-message" style="color:red">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    @for($j=0;$j<$cont2;$j++)
                                    <tr>
                                        <td style="width:100px"><input type="number" class="form-control" placeholder="Nº" name="cantidadsevicio[]" id="cantidadsevicio{{$j}}" wire:model="cantidadsevicio.{{$j}}">
                                        ...
                                        <td>
                                            <input type="number" class="form-control" name="precio_operacion[]" id="precio_operacion{{$j}}" wire:model="precio_operacion.{{$j}}" step="0.01" placeholder="Precio">
